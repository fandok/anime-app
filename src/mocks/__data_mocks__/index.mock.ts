export const mockListResponse = {
  pagination: {
    last_visible_page: 1600,
    has_next_page: true,
    current_page: 1,
    items: { count: 15, total: 23993, per_page: 15 },
  },
  data: [
    {
      mal_id: 1,
    ...
    },
    {
      ...
      approved: true,
      titles: [
        { type: "Default", title: "Cowboy Bebop: Tengoku no Tobira" },
        { type: "Synonym", title: "Cowboy Bebop: Knockin' on Heaven's Door" },
        {
          type: "Japanese",
          title:
            "\u30ab\u30a6\u30dc\u30fc\u30a4\u30d3\u30d0\u30c3\u30d7 \u5929\u56fd\u306e\u6249",
        },
        { type: "English", title: "Cowboy Bebop: The Movie" },
        { type: "German", title: "Cowboy Bebop: Der Film" },
        { type: "Spanish", title: "Cowboy Bebop: La Pel\u00edcula" },
        { type: "French", title: "Cowboy Bebop: Le Film" },
      ],
    ...
    },
    {
      ...
      approved: true,
      titles: [
        { type: "Default", title: "Trigun" },
        { type: "Japanese", title: "\u30c8\u30e9\u30a4\u30ac\u30f3" },
        { type: "English", title: "Trigun" },
      ],
      title: "Trigun",
      ...
      aired: {
        ...
        prop: {
          from: { day: 1, month: 4, year: 1998 },
          to: { day: 30, month: 9, year: 1998 },
        },
    ...
    },
    {
      ...
      approved: true,
      titles: [
        { type: "Default", title: "Witch Hunter Robin" },
        { type: "Synonym", title: "WHR" },
        {
          type: "Japanese",
          title:
            "Witch Hunter ROBIN (\u30a6\u30a4\u30c3\u30c1\u30cf\u30f3\u30bf\u30fc\u30ed\u30d3\u30f3)",
        },
        { type: "English", title: "Witch Hunter Robin" },
      ],
      ...
      aired: {
        ...
        prop: {
          from: { day: 3, month: 7, year: 2002 },
          to: { day: 25, month: 12, year: 2002 },
        },
    ...
    },
    {
      ...
      approved: true,
      titles: [
        { type: "Default", title: "Bouken Ou Beet" },
        { type: "Synonym", title: "Adventure King Beet" },
        { type: "Japanese", title: "\u5192\u967a\u738b\u30d3\u30a3\u30c8" },
        { type: "English", title: "Beet the Vandel Buster" },
      ],
      ...
      aired: {
        ...
        prop: {
          from: { day: 30, month: 9, year: 2004 },
          to: { day: 29, month: 9, year: 2005 },
        },
